...
gulp.task('sass', function () {
  return gulp.src(path.scssInputFiles)
    ...
    .pipe(gulp.dest(path.cssOutputFolder))
...
gulp.task('watch', ['browser-sync', 'compile'], function () {
      gulp.watch(path.scssInputFiles, ['compile']);
      gulp.watch('./*.html', browserSync.reload);
      gulp.watch(path.jsOutputFiles, browserSync.reload);
      gulp.watch(path.cssOutputFiles, browserSync.reload);
});
